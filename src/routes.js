...
import IdiomaAlemanPage from './components/pages/StaticContent/IdiomaAlemanPage';
import IntercambiosPage from './components/pages/StaticContent/IntercambiosPage';
import SobreNosotrosPage from './components/pages/StaticContent/SobreNosotrosPage';
import MasPage from './components/pages/StaticContent/MasPage';

import Instalaciones from './components/pages/StaticContent/menutabspages/Instalaciones';
import IntercambioCultural from './components/pages/StaticContent/menutabspages/IntercambioCultural';
import IntercambioEstudiantil from './components/pages/StaticContent/menutabspages/IntercambioEstudiantil';
import CursosDeAleman from './components/pages/StaticContent/menutabspages/CursosDeAleman';
import ExamenesDeAleman from './components/pages/StaticContent/menutabspages/ExamenesDeAleman';
import NuestraHistoria from './components/pages/StaticContent/menutabspages/NuestraHistoria';
import PorQueAprenderAleman from './components/pages/StaticContent/menutabspages/PorQueAprenderAleman';
...
const routes = (
    <Route name="app" path="/" handler={Application}>
        ...
        <Route name="becas" handler={MasPage} />
        <Route name="sobre-nosotros" handler={SobreNosotrosPage} />
        <Route name="intercambios" handler={IntercambiosPage} />
        <Route name="idioma-aleman" handler={IdiomaAlemanPage} />
        ...
        <Route name="instalaciones" handler={Instalaciones} />
        <Route name="intercambio-cultural" handler={IntercambioCultural} />
        <Route name="intercambio-estudiantil" handler={IntercambioEstudiantil} />
        <Route name="cursos-de-aleman" handler={CursosDeAleman} />
        <Route name="examenes-de-aleman" handler={ExamenesDeAleman} />
        <Route name="nuestra-historia" handler={NuestraHistoria} />
        <Route name="porque-aprender-aleman" handler={PorQueAprenderAleman} />
